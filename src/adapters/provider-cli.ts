...
export const providerCliNames = ['codex', 'claude', 'gemini'] as const;
...
export class ProviderCliInstallError extends Error {
  public constructor(provider: ProviderCliName, reason: 'npm_missing' | 'install_failed' | 'not_detected_after_install') {
